...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CdjJfNNC.mjs");
...
const manifest = {
  "2e6c5984257a9490acd03ada31986d35710851a2b721234becd8b54e1ca2ac05": {
    functionName: "getReportsList_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "5f58f084809b64b6517ed6aa86e47a38904dd0642034378eeb685e66c41ed661": {
    functionName: "getKpiMetrics_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "870efd443bfbd1564bf1fef7ec2da63bab38740abb8cb079cc14ea7a109a79f5": {
    functionName: "pingWebhook_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "91e8e1f1466568e6544c7e5a9b51fc0d33c169f5ad654b11af680c6e277e8930": {
    functionName: "callWebhook_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "96f3c5d100a81ebb99d4a044c4607dfebad2432d683f38ef35a6f175d5fb6ab9": {
    functionName: "createReport_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "af531a086d1cdac0f5a0f14ecc53598cd1bce4e709c0448137705fce0186cef5": {
    functionName: "getPatternInsights_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  },
  "db0ed0bb4c40d853f02d9f53ca7d87dd29f340323cd4ac1060460a2b78c4a57b": {
    functionName: "getAgentsList_createServerFn_handler",
    importer: () => import("./data.functions-DM_6IGVb.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B1-3qRBV.mjs").then((n) => n.r),
    import("./start-CYmU_9Ba.mjs"),
